...
namespace Polly
{
    public partial class Policy
    {
        ...
        public static TokenBucketPolicy TokenBucketAsync(double bucketSize, double bucketFillRate)
        {
            TokenBucketValidator.ValidateSecondsTimeout(bucketSize, bucketFillRate);
            Func<Context, Task, Exception, Task> doNothingAsync = (_, ___, ____) => TaskHelper.EmptyTask;

            return TokenBucketAsync(ctx => Tuple.Create(bucketSize, bucketFillRate), TokenBucketStrategy.Optimistic, doNothingAsync);
        }
        ...
        /// <exception cref="System.ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="System.ArgumentNullException">onTimeoutAsync</exception>
        public static TokenBucketPolicy TokenBucketAsync(Func<Context, Tuple<double, double>> timeoutProvider, TokenBucketStrategy timeoutStrategy
