...
namespace Polly
{
    public partial class Policy
    {
        ...
        public static TokenBucketPolicy<TResult> TokenBucket<TResult>(double bucketSize, double bucketFillRate)
        {
            TokenBucketValidator.ValidateSecondsTimeout(bucketSize, bucketFillRate);
            Action<Context, Task, Exception> doNothing = (_, ___, ____) => { };

            return TokenBucket<TResult>(ctx => Tuple.Create(bucketSize, bucketFillRate), TokenBucketStrategy.Optimistic, doNothing);
        }
        ...
        /// <exception cref="System.ArgumentNullException">timeoutProvider</exception>
        /// <exception cref="System.ArgumentNullException">onTimeout</exception>
        public static TokenBucketPolicy<TResult> TokenBucket<TResult>(Func<Context, Tuple<double, double>> timeoutProvider, TokenBucketStrategy TokenBucketStrategy, Action<Context, Task, Exception> onTimeout)
        {
            if (timeoutProvider == null) throw new ArgumentNullException(nameof(timeoutProvider));
            if (onTimeout == null) throw new ArgumentNullException(nameof(onTimeout));
